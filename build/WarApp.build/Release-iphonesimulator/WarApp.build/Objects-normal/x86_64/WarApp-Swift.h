...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WarApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6WarApp11AppDelegate")
...
SWIFT_CLASS("_TtC6WarApp13SceneDelegate")
...
SWIFT_CLASS("_TtC6WarApp14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified leftCard;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified rightCard;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerScore;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified cpuScore;
- (void)viewDidLoad;
- (IBAction)onDealPress:(id _Nonnull)sender;
